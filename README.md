...
[![Build Status](https://travis-ci.org/dev-denner/spotify-wrapper.svg?branch=master)](https://travis-ci.org/dev-denner/spotify-wrapper) [![Coverage Status](https://coveralls.io/repos/github/dev-denner/spotify-wrapper/badge.svg?branch=master)](https://coveralls.io/github/dev-denner/spotify-wrapper?branch=master)
...
| ![Denner Fernandes](https://avatars.githubusercontent.com/u/3027789?v=4&s=150)|
|:---------------------:|
|  [Denner Fernandes](https://github.com/dev-denner/)   |

See also the list of [contributors](https://github.com/dev-denner/spotify-wrapper/contributors) who participated in this project.
